...
- **Input**: Audio files (mp3/wav/m4a/ogg/flac/webm) and/or meeting tool transcripts (txt/srt/vtt/json)
...
- **Docs**: `docs/en/` (English), `docs/ja/` (Japanese) — data format spec + architecture
- **Security**: Nonce-tagged XML wrapping for prompt injection; immediate file deletion after Gemini processing
